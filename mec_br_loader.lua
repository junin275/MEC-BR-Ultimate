...
-- =============================================================================
local Config = {
    CredenciaisURL  = "https://gist.githubusercontent.com/junin275/7d81a1a50aeb65aa337cd09b35fd2a26/raw",
    MainScriptURL   = "https://raw.githubusercontent.com/junin275/MEC-BR-Ultimate/refs/heads/main/mec_br_main.lua",
    ServiceId       = 28226,
...
local function CreateGUI()
    ...
    VerifyBtn.MouseButton1Click:Connect(function()
        ...
        if success then
            Status.Text = "Key valida! Carregando..."; Status.TextColor3 = Color3.fromRGB(0, 255, 100)
    ...
    GetKeyBtn.MouseButton1Click:Connect(function()
        ...
        if success then
            fSetClipboard(link)
            Status.Text = "Link copiado! Abra no navegador."; Status.TextColor3 = Color3.fromRGB(0, 200, 100)
        else
        ...
        if savedKey ~= "" then
            ...
            task.spawn(function()
                ...
                if success then
                    ...
                    Status.Text = "Key expirada."; Status.TextColor3 = Color3.fromRGB(255, 150, 0)
                end
            end)
        end
    end
...
if not credsOk then
    print("[MEC BR] Aviso: Usando ServiceId e PlatoSecret dos defaults. Configure CredenciaisURL!")
end
